        ...
        n.forEach(function(e) {
            ...
            if (n = o[u])
                ...
                r[n.start] = o[n.end] = n;
                    ...
                    if (delete r[n.start], n.unshift(e)
                        , n.start = u, a = o[u]) {
                delete o[a.end];
...
function o(e, n) {
    ...
    var s = d(e.transform), f = e.arcs, l = {
        Point: function(e) {
...
function l(e) {
    ...
    function t(n) {
        for (var t = o[n]; ;) {
            ...
            if (a < o.length && e(o[a], u) < 0 && (u = o[i = a]), r < o.length && e(o[r], u) < 0 && (u = o[i = r])
                , i === n)break;
